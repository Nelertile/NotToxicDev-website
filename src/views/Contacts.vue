<template>
    <main class="contacts-page">
        ...
        <div class="socials">
            ...
            <a href="https://github.com/NotToxicDev" class="github"><i class="fab fa-github"></i> GitHub |</a>
            <a href="https://discord.gg/GNRC2Gu5Yb" class="discord"><i class="fab fa-discord"></i> Discord |</a>
       </div>
    </main>
</template>
